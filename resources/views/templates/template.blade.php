...
<body>
    <nav class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
        <a class="navbar-brand col-md-3 col-lg-2 mr-0 px-3" href="#">COVID19 PM-RO</a>
            ...
            <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
                <div class="sidebar-sticky pt-3">
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ url('pessoas/create') }}">
                                <span data-feather="users"></span>
                                Pessoas
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ url('infracoes/create') }}">
                    ...
                    <ul class="nav flex-column mb-2">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ url('infracoes') }}">
    ...
    <!-- Jquery Mask -->
    <script src="{{ url('assets/js/mask/jquery.mask.js') }}"></script>
